...
title: " HyDiad parameers based on DiadES survey and bibliography"
output: 
...
fish <- tibble(latin_name = c("Alosa alosa", "Alosa fallax",  "Lampetra fluviatilis",  "Petromyzon marinus", "Salmo salar", "Salmo trutta",
  ...
  inner_join(speciesName, by = 'latin_name') 

read_rds("./brt/brt_input/basinSpecies.RDS") %>% as_tibble()
read_rds("./brt/brt_input/eurodiadAA.RDS") %>% as_tibble()
read_rds("./brt/brt_input/calibrationSet.RDS") %>% as_tibble()
```
