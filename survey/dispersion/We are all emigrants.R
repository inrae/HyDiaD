...
#saveRDS(dmUse, file = 'C:/Users/Mustafa/Documents/Work/BetsyHSDM/dmUse.RDS')
readRDS("C:/Users/Mustafa/Documents/Work/BetsyHSDM/dmUse.RDS")

## All fish emigrate
# reference points
y = 0.1629 # Proportion emigrants from survey
# For old dispersal kernal
dispersal_1 = data.frame(D = c(40.47, 255.51), pAfter = c(.5, .1))
dispersal_1$pBefore = 1 - dispersal_1$pAfter
# For including ALL fish in the dispersal kernal
